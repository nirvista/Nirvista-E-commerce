    ...
    if (Platform.isAndroid && !Platform.isIOS) {
      Constant.sendToScreen(
        SelectionDialog(
          ...
          flagDecoration: widget.flagDecoration, hideHeaderText: false, headerAlignment: MainAxisAlignment.start, headerTextStyle: TextStyle(), topBarPadding: EdgeInsets.zero,
        ),
        context,
        (e) {
          if (e != null) {
      ...
      Constant.sendToScreen(
        SelectionDialog(
          ...
          hideHeaderText: false, headerAlignment: MainAxisAlignment.start, headerTextStyle: TextStyle(), topBarPadding: EdgeInsets.zero,
        ),
        context,
        (e) {
          if (e != null) {
