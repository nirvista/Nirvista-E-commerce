            ...
            child: img.isNotEmpty 
              ? Image.network(
                  ...
                  errorBuilder: (context, error, stackTrace) => Center(
                    child: Icon(Icons.image_not_supported_outlined, size: 30.w, color: Colors.grey),
                  ),
              ...
              : Center(child: Icon(Icons.image_not_supported_outlined, size: 30.w, color: Colors.grey)),
          ),
          SizedBox(width: 12.w),
          Expanded(
            child: Column(
